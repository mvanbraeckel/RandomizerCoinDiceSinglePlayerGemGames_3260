class Item < ApplicationRecord
  ...
  with_options if: :is_coin? do |coin|
    coin.validates :denomination, presence: true, numericality: { greater_than: 0.0 },
      #inclusion: { in: %w(0.05 0.1 0.10 0.25 1 1.0 1.00 2 2.0 2.00), message: "value '%{value}' is not a valid coin denomination" }, allow_blank: false,
      format: { with: /\A(0.05|0.1|0.10|0.25|1|1.0|1.00|2|2.0|2.00)\z/, message: "value '%{value}' is not a valid coin denomination." }
